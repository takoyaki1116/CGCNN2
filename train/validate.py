...
def validate(args, val_loader, model_a, model_b, model, activation_a, activation_b, criterion, normalizer, test=False, tc=False):
    ...
    if test:
        if not tc:
            ...
            plt.title("Prediction by CGCNN with Combined Model Transfer Learning")
            plt.xlabel("observation")
            plt.ylabel("prediction")
            plt.show()

        else:
            return graph_output, graph_target
